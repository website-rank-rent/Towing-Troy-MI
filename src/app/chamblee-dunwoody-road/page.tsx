        ...
        <div className="relative z-10 bg-black/30 backdrop-blur-sm min-h-screen flex items-center justify-center px-4 py-20">
          <main className="max-w-3xl bg-black/80 text-white p-8 rounded-xl shadow-lg">
            ...
            <p className="mb-4 text-lg">
              If your vehicle breaks down near Dunwoody High School, Georgetown Shopping Center, or anywhere along Chamblee Dunwoody Road, we&rsquo;ve got you covered. Our team responds quickly, day or night.
            </p>

            <p className="mb-4 text-lg">
              We&rsquo;re familiar with every twist and turn of this road and can dispatch a truck to your location within minutes — no waiting, no stress.
            </p>
            ...
            <p className="mb-4 text-lg">
              Whether you&rsquo;re near apartment complexes, local parks, or neighborhood intersections, we&rsquo;re nearby and ready to assist with dependable roadside service.
            </p>
            ...
            <p className="text-lg mb-8">
              ...
              — we&rsquo;re available 24/7 to get you moving again.
            </p>
