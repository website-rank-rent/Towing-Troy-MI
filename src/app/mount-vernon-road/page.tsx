    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 bg-black/30 backdrop-blur-sm min-h-screen flex items-center justify-center px-4 py-20">
        <main className="max-w-3xl bg-black/80 text-white p-8 rounded-xl shadow-lg">
          <h1 className="text-4xl font-bold mb-6">Towing Service on Mount Vernon Road, Dunwoody</h1>
          ...
          <p className="mb-4 text-lg">
            ...
            Whether you're near the Dunwoody Library, Georgia State Route 9, or Dunwoody Village Parkway — we’ll get there fast.
          </p>

          <p className="text-lg mb-8">
            Call now for immediate towing on Mount Vernon Road:  
            <a href="tel:+18665307414" className="text-blue-400 font-semibold"> (866) 530-7414</a>
          </p>
