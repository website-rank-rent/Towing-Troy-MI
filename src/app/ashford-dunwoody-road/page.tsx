        ...
        <div className="relative z-10 bg-black/30 backdrop-blur-sm min-h-screen flex items-center justify-center px-4 py-20">
          <main className="max-w-3xl bg-black/80 text-white p-8 rounded-xl shadow-lg">
            ...
            <p className="mb-4 text-lg">
              Whether you&rsquo;re stalled near Perimeter Mall, the Crowne Plaza, or stuck in traffic close to I-285, our tow truck drivers are already in the Dunwoody area and ready to respond.
            </p>

            <p className="mb-4 text-lg">
              We&rsquo;re proud to offer trusted, fast towing services along Ashford Dunwoody Road — no matter the time of day or traffic conditions.
            </p>
            ...
            <p className="mb-4 text-lg">
              With heavy office park traffic and constant congestion, Ashford Dunwoody Road can be tough to navigate — but we&rsquo;re right around the corner and can get you off the shoulder fast.
            </p>
