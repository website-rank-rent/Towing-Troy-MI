        ...
        <div className="relative z-10 bg-black/30 backdrop-blur-sm min-h-screen flex items-center justify-center px-4 py-20">
          <main className="max-w-3xl bg-black/80 text-white p-8 rounded-xl shadow-lg">
            ...
            <p className="mb-4 text-lg">
              Dealing with a breakdown near City Walk, Abernathy Greenway, or driving toward I-285? We&rsquo;re your go-to towing service along Roswell Road — no matter where you&rsquo;re stuck.
            </p>

            <p className="mb-4 text-lg">
              Our drivers are already in the area and can assist quickly, whether you&rsquo;re near a gas station, apartment complex, or shopping plaza. Just give us a call.
            </p>
            ...
            <p className="mb-4 text-lg">
              Roswell Road is busy and unpredictable — we understand the urgency. That&rsquo;s why our team is always nearby and ready to respond within 20–30 minutes in most cases.
            </p>
